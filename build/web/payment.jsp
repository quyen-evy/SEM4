<%-- 
    Document   : payment
    Created on : Dec 25, 2020, 10:36:55 AM
    Author     : Quyen Evy
--%>
...
<body>
	<div class="main">	
		...
		<div class="w3_agile_main_grids">
			<div class="w3layouts_main_grid_left">
				<div class="agileinfo_main_grid_left_grid">
					...
					<ul>
						<li>Movie name<span>2017 February 10, at 10:30 PM</span></li>
						<li>CAF</li>
					</ul>
					<ul>
						<li>Show time<span>2017 February 25, at 1:30 PM</span></li>
						<li>JFK</li>
					</ul>
					<ul>
						<li>Screening<span>2017 March 17, at 08:30 PM</span><span>2017 March 19, at 08:30 PM</span></li>
						<li>LHR</li>
					</ul>
					<ul>
						<li>Seat<span>2017 April 09, at 10:00 AM</span></li>
						<li>JFK</li>
					</ul>
                                        <ul>
						<li>Ticket price<span>2017 April 09, at 10:00 AM</span></li>
						<li>JFK</li>
					</ul>
				</div>
		...
		<div class="agileits_copyright">
			<p>© 2020 Movie Payment. Design by <a href="#" target="_blank">TiQi Company</a></p>
		</div>
	</div>
	<!-- credit-card -->
